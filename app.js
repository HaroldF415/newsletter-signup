...
app.post("/", function(req, res) {
  ...
  const url = "https://usX.api.mailchimp.com/3.0/lists/unique_list_id_goes_here"; // This will come from the main mail-chimp 'endpoint'

  const options = {
    method: "POST",
    auth: "user_id:your_unique_user_id_goes_here-usX"
  };
